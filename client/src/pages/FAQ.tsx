...
const faqItems: FAQItem[] = [
  {
    id: "1",
    question: "ما هي CrediFy؟",
    answer:
      "CrediFy هي منصة موثوقة للتحقق من موثوقية الحسابات والأشخاص. توفر معلومات عن الحسابات الموثوقة والمحتالين لمساعدة المستخدمين على اتخاذ قرارات آمنة.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    answer:
      "لا, CrediFy مجانية تماماً. جميع الخدمات متاحة للجميع دون أي رسوم. نحن نؤمن بأهمية حماية المجتمع من الاحتيال.",
  },
  {
    id: "10",
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                إجابات على الأسئلة الشائعة حول CrediFy
              </p>
            </div>
